...
function About() {
  return (
    ...
    <div
      ...
      ></div>
      <div className="phs-dna-content-wrapper-1">
      ...
      <div className="phs-dna-content-wrapper-2 pb-10">
      <h1 className="phs-contact-us-title flex flex-col items-center text-2xl pt-8">How does this work?</h1>
      <p>All you need to do is to contact us, telling us what would be your dream house. We will take care of the rest for you.
      </p>
      </div>
    </div>
    <BottomNav/>
