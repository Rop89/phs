...
function BottomNav() {
  return (
    ...
    <div className="phs-hero-bottom-nav flex flex-col items-center">
      ...
      <div className="phs-column-bottom-nav flex flex-col items-start pt-4">
        ...
        <div className="copyrights-wrapper flex items-center mt-12">
        <span className="phs-copyright text-xs">© Copyright PHS 2020. All rights reserved.</span>
        </div>
        <hr className=""></hr>
      </div>
    </div>
